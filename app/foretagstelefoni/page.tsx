...
const serviceCategories = [
  {
    ...
    description: "Moderna mobiltelefoner, skräddarsydda abonnemang och headset för företag.",
  },
  {
    title: "VoIP & Företagsväxel",
    ...
    description: "IP-baserade telefonisystem, moderna växellösningar och molnbaserade telefontjänster.",
  },
  {
        ...
        <main className="flex-grow">
          ...
          <section className="relative min-h-[80vh] flex items-center justify-center text-center px-4">
            ...
            <div className="relative z-10">
              ...
              >
                Moderna telefoni­lösningar för företag – från mobiltelefoner och VoIP till konferenssystem och företagsväxlar.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
