...
Sitemap: https://stjarnafyrkant.se/sitemap.xml`,
            points: [
              ...
              "Disallow: /dev → Blockera dev-sidor från Google",
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 py-16">
        ...
        {/* Technical Guides */}
        <section className="mb-16">
          <AnimatedText text="Kompletta Tekniska Guider" el="h2" className="text-4xl font-bold mb-8" />
                  ...
                  >
                    <SubtleCard className="p-6 md:p-8">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          <h4 className="text-2xl font-semibold mb-2">{guide.title}</h4>
                          <p className="text-muted-foreground mb-2">{guide.description}</p>
                          {guide.codeFile && (
                            <div className="flex items-center gap-2 text-sm">
                              <FileText size={14} className="text-primary" />
                              <code className="text-primary">{guide.codeFile}</code>
                            </div>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        {guide.details.map((detail, index) => (
                          <div key={index}>
                            ...
                            {detail.code && (
                              <div className="relative bg-card/50 border rounded-lg p-4 mb-3 font-mono text-sm overflow-x-auto">
                                <pre className="whitespace-pre-wrap">{detail.code}</pre>
                              </div>
                            )}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <a href="/ui-kit" className="flex items-center gap-2 hover:text-primary transition-colors">
                    <ArrowRight size={16} />
                    UI Kit & Designsystem
                  </a>
                  <a href="/seo-plan" className="flex items-center gap-2 hover:text-primary transition-colors">
                    <ArrowRight size={16} />
