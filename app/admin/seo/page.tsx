        ...
        <main className="flex-grow container mx-auto px-4 py-16">
          <div className="text-center my-16">
            ...
            <div className="flex justify-center gap-3 mt-6">
              <Link href="/admin/dev" className="px-4 py-2 rounded-lg bg-card/50 border hover:bg-primary/10 transition-colors text-sm font-medium">
                Developer Hub
              </Link>
              <Link href="/admin/ui-kit" className="px-4 py-2 rounded-lg bg-card/50 border hover:bg-primary/10 transition-colors text-sm font-medium">
                UI Kit
              </Link>
            </div>
          </div>
