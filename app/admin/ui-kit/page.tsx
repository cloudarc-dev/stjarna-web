          ...
          <div className="text-center my-16">
            ...
            >
              ...
              <div className="mt-4 pt-4 border-t border-border/50 flex justify-center gap-3">
                <a href="/admin/dev" className="px-3 py-1.5 rounded-md bg-primary/10 hover:bg-primary/20 transition-colors text-xs font-medium">
                  Developer Hub
                </a>
                <a href="/admin/seo" className="px-3 py-1.5 rounded-md bg-primary/10 hover:bg-primary/20 transition-colors text-xs font-medium">
                  SEO Plan
                </a>
              </div>
            </motion.div>
