...
export function Footer() {
  return (
    <footer className="border-t py-16 bg-gray-100 dark:bg-card/20">
      <div className="container max-w-screen-2xl grid grid-cols-1 md:grid-cols-4 gap-12">
        <div>
          <div className="mb-4">
            <Image
          ...
          <p className="text-muted-foreground mb-6">Lokal närvaro, hållbart ansvar.</p>
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="tel:+4690704470" className="hover:text-primary">
                090-70 44 70
              </a>
            </div>
            <div className="flex items-center gap-2">
              <Mail className="w-4 h-4 flex-shrink-0" />
              <a href="mailto:umea@stjarnafyrkant.se" className="hover:text-primary">
          ...
          <div className="mt-6 flex items-center gap-3">
            <a
              href="https://www.facebook.com/stjarnafyrkantvb/"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/stjarnafyrkantvb/"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary transition-colors"
            ...
            <a
              href="https://www.linkedin.com/company/stjarnafyrkant-lts/"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary transition-colors"
              aria-label="LinkedIn"
            ...
            <a
              href="https://www.youtube.com/@stjarnafyrkant6026"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary transition-colors"
              aria-label="YouTube"
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Vi hjälper företag i Västerbotten med IT, fordonsteknik och kommunikation.
          </p>
          <Link href="/#kontakt">
